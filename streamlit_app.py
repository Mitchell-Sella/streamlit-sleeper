...
draft_assistant_page = st.Page("app_pages/draft_assistant.py", title="Draft Assistant", icon=":material/format_list_numbered:")

# Setup Navigation
pg = st.navigation({
    "Analysis": [trade_page, draft_page, trade_finder_page, draft_assistant_page]
})
